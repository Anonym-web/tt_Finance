...
public class SXClient {
    public static void main(String[] args) {
        // 装载处理后的原数据
//        CopyOnWriteArrayList<String> rawDataList = DisposeSXRawData.disposeSXRawData("G:\\铁通工作\\自己接到的\\省份数据\\陕西\\陕西十二月\\陕西", 0, 3, "2020-12");
...
//        CopyOnWriteArrayList<String> rosterList = ReadSXRosterData.readSXRosterData("G:\\铁通工作\\自己接到的\\省份数据\\陕西\\陕西十二月\\陕西人员信息数据（12月)-全省汇总.xlsx", 6, "2020-12");

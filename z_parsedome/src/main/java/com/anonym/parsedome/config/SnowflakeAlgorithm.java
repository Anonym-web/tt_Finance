...
public class SnowflakeAlgorithm {
    ...
    private static class SnowFlake {
         ...
         * 内部类对象（单例模式）
         */
        private static final SnowflakeAlgorithm.SnowFlake SNOW_FLAKE = new SnowflakeAlgorithm.SnowFlake();
        /**
         * 起始的时间戳
         */
    ...
    public static long uniqueLong() {
        return SnowflakeAlgorithm.SnowFlake.SNOW_FLAKE.nextId();
    }
    /**
     * 获取String类型雪花ID
     */
    ...
    public static void main(String[] args) throws InterruptedException {
        Long ls = SnowflakeAlgorithm.uniqueLong();
        System.out.println(ls);
        System.out.println(ls.toString().length());
    }
}

 ...
 */
@Configuration
@MapperScan(basePackages = "com.anonym.parsedome.mapper.ttwhmis", sqlSessionTemplateRef  = "ttwhmisSqlSessionTemplate")
public class TTwhmisConfig {
    ...
    public SqlSessionFactory testSqlSessionFactory(@Qualifier("ttwhmisDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mybatis/ttwhmisMapper/*.xml"));
